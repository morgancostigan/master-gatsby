let path,fetch;_874‍.x([["sourceNodes",()=>sourceNodes],["createPages",()=>createPages]]);_874‍.w("path",[["default",["path"],function(v){path=v}]]);_874‍.w("isomorphic-fetch",[["default",["fetch"],function(v){fetch=v}]]);
...
async function turnPeopleIntoPages({ graphql, actions }) {
    //1. get template
    const personTemplate = path.resolve('./src/templates/SlicemastersTemplate.js');
    ...
    data.people.nodes.forEach(person => {
        _874‍.g.console.log('creating', person.name);
        actions.createPage({
            //what's the URL for this new page
