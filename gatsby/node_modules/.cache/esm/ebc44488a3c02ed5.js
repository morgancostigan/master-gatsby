let path;_a3c‍.x([["createPages",()=>createPages]]);_a3c‍.w("path",[["default",["path"],function(v){path=v}]]);
...
async function turnPizzasIntoPages({graphql, actions}) {
    ...
    `);
    _a3c‍.g.console.log({data});
    //3. loop over pizzas and create a page for each
    data.pizzas.nodes.forEach(pizza => {
        _a3c‍.g.console.log('creating', pizza.name);
        actions.createPage({
...
async function turnToppingsIntoPages({ graphql, actions }) {
    ...
    data.toppings.node.forEach(topping => {
        _a3c‍.g.console.log('creatin page for', topping.name);
