let path,fetch;_a7b‍.x([["sourceNodes",()=>sourceNodes],["createPages",()=>createPages]]);_a7b‍.w("path",[["default",["path"],function(v){path=v}]]);_a7b‍.w("isomorphic-fetch",[["default",["fetch"],function(v){fetch=v}]]);
...
async function turnPeopleIntoPages({ graphql, actions }) {
    ...
    data.people.nodes.forEach(person => {
        _a7b‍.g.console.log('creating', person.name);
        actions.createPage({
            //what's the URL for this new page
