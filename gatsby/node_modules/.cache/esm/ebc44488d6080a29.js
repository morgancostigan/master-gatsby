let path,fetch;_d60‍.x([["sourceNodes",()=>sourceNodes],["createPages",()=>createPages]]);_d60‍.w("path",[["default",["path"],function(v){path=v}]]);_d60‍.w("isomorphic-fetch",[["default",["fetch"],function(v){fetch=v}]]);
...
async function turnPeopleIntoPages({ graphql, actions }) {
    ...
    data.people.nodes.forEach(person => {
        _d60‍.g.console.log('creating', person.name);
        actions.createPage({
            //what's the URL for this new page
