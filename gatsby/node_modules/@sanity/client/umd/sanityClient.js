...
},{"object-assign":23,"url-parse":55}],7:[function(require,module,exports){
...
},{"parse-headers":24,"same-origin":52}],14:[function(require,module,exports){
...
},{"for-each":3,"trim":54}],25:[function(require,module,exports){
"use strict";function decode(e){return decodeURIComponent(e.replace(/\+/g," "))}function querystring(e){for(var r,n=/([^=?&]+)=?([^&]*)/g,t={};r=n.exec(e);){var o=decode(r[1]),i=decode(r[2]);o in t||(t[o]=i)}return t}function querystringify(e,r){r=r||"";var n=[];"string"!=typeof r&&(r="?");for(var t in e)has.call(e,t)&&n.push(encodeURIComponent(t)+"="+encodeURIComponent(e[t]));return n.length?r+n.join("&"):""}var has=Object.prototype.hasOwnProperty;exports.stringify=querystringify,exports.parse=querystring;
...
"use strict";function getPromiseCtor(r){if(r||(r=config_1.config.Promise||Promise),!r)throw new Error("no Promise impl found");return r}Object.defineProperty(exports,"__esModule",{value:!0});var toSubscriber_1=require("./util/toSubscriber"),observable_1=require("../internal/symbol/observable"),pipe_1=require("./util/pipe"),config_1=require("./config"),Observable=function(){function r(r){this._isScalar=!1,r&&(this._subscribe=r)}return r.prototype.lift=function(e){var o=new r;return o.source=this,o.operator=e,o},r.prototype.subscribe=function(r,e,o){var t=this.operator,n=toSubscriber_1.toSubscriber(r,e,o);if(t?t.call(n,this.source):n._addParentTeardownLogic(this.source||config_1.config.useDeprecatedSynchronousErrorHandling&&!n.syncErrorThrowable?this._subscribe(n):this._trySubscribe(n)),config_1.config.useDeprecatedSynchronousErrorHandling&&n.syncErrorThrowable&&(n.syncErrorThrowable=!1,n.syncErrorThrown))throw n.syncErrorValue;return n},r.prototype._trySubscribe=function(r){try{return this._subscribe(r)}catch(e){config_1.config.useDeprecatedSynchronousErrorHandling&&(r.syncErrorThrown=!0,r.syncErrorValue=e),r.error(e)}},r.prototype.forEach=function(r,e){var o=this;return new(e=getPromiseCtor(e))(function(e,t){var n;n=o.subscribe(function(e){try{r(e)}catch(r){t(r),n&&n.unsubscribe()}},t,e)})},r.prototype._subscribe=function(r){var e=this.source;return e&&e.subscribe(r)},r.prototype[observable_1.observable]=function(){return this},r.prototype.pipe=function(){for(var r=[],e=0;e<arguments.length;e++)r[e]=arguments[e];return 0===r.length?this:pipe_1.pipeFromArray(r)(this)},r.prototype.toPromise=function(r){var e=this;return new(r=getPromiseCtor(r))(function(r,o){var t;e.subscribe(function(r){return t=r},function(r){return o(r)},function(){return r(t)})})},r.create=function(e){return new r(e)},r}();exports.Observable=Observable;
},{"../internal/symbol/observable":39,"./config":31,"./util/pipe":49,"./util/toSubscriber":50}],28:[function(require,module,exports){
...
},{"./util/UnsubscriptionError":42,"./util/errorObject":43,"./util/isArray":45,"./util/isFunction":46,"./util/isObject":47,"./util/tryCatch":51}],31:[function(require,module,exports){
...
},{"../util/pipe":49,"./defaultIfEmpty":33,"./scan":37,"./takeLast":38}],37:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.rxSubscriber="function"==typeof Symbol&&"function"==typeof Symbol.for?Symbol.for("rxSubscriber"):"@@rxSubscriber",exports.$$rxSubscriber=exports.rxSubscriber;
...
},{"./noop":48}],50:[function(require,module,exports){
...
},{"../Observer":28,"../Subscriber":29,"../symbol/rxSubscriber":40}],51:[function(require,module,exports){
...
},{"./errorObject":43}],52:[function(require,module,exports){
...
},{"querystringify":25,"requires-port":26}],56:[function(require,module,exports){
"use strict";function AssetsClient(e){this.client=e}function toDocument(e){var t=e.document;return Object.defineProperty(t,"document",{enumerable:!1,get:function(){return console.warn("The promise returned from client.asset.upload(...) now resolves with the asset document"),t}}),t}function optionsFromFile(e,t){return"undefined"!=typeof window&&t instanceof window.File?assign({filename:!1===e.preserveFilename?void 0:t.name,contentType:t.type},e):e}var _slicedToArray=function(){function e(e,t){var r=[],n=!0,i=!1,o=void 0;try{for(var a,s=e[Symbol.iterator]();!(n=(a=s.next()).done)&&(r.push(a.value),!t||r.length!==t);n=!0);}catch(e){i=!0,o=e}finally{try{!n&&s.return&&s.return()}finally{if(i)throw o}}return r}return function(t,r){if(Array.isArray(t))return t;if(Symbol.iterator in Object(t))return e(t,r);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),assign=require("object-assign"),_require=require("@sanity/observable/operators/map"),map=_require.map,_require2=require("@sanity/observable/operators/filter"),filter=_require2.filter,queryString=require("../http/queryString"),validators=require("../validators");assign(AssetsClient.prototype,{upload:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{};validators.validateAssetType(e);var n=r.extract||void 0;n&&!n.length&&(n=["none"]);var i=validators.hasDataset(this.client.clientConfig),o="image"===e?"images":"files",a=optionsFromFile(r,t),s=a.label,l=a.filename,u={label:s,filename:l,meta:n},c=this.client._requestObservable({method:"POST",timeout:a.timeout||0,uri:"/assets/"+o+"/"+i,headers:a.contentType?{"Content-Type":a.contentType}:{},query:u,body:t});return this.client.isPromiseAPI()?c.pipe(filter(function(e){return"response"===e.type}),map(function(e){return toDocument(e.body)})).toPromise():c},delete:function(e,t){console.warn("client.assets.delete() is deprecated, please use client.delete(<document-id>)");var r=t||"";return/^(image|file)-/.test(r)?e._id&&(r=e._id):r=e+"-"+r,validators.hasDataset(this.client.clientConfig),this.client.delete(r)},getImageUrl:function(e,t){var r=e._ref||e;if("string"!=typeof r)throw new Error("getImageUrl() needs either an object with a _ref, or a string with an asset document ID");if(!/^image-[A-Za-z0-9_]+-\d+x\d+-[a-z]{1,5}$/.test(r))throw new Error('Unsupported asset ID "'+r+'". URL generation only works for auto-generated IDs.');var n=r.split("-"),i=_slicedToArray(n,4),o=i[1],a=i[2],s=i[3];validators.hasDataset(this.client.clientConfig);var l=this.client.clientConfig;return"https://cdn.sanity.io/images/"+l.projectId+"/"+l.dataset+"/"+o+"-"+a+"."+s+(t?queryString(t):"")}}),module.exports=AssetsClient;

},{"../http/queryString":67,"../validators":76,"@sanity/observable/operators/filter":81,"@sanity/observable/operators/map":82,"object-assign":23}],57:[function(require,module,exports){
...
},{"object-assign":23}],58:[function(require,module,exports){
...
},{"../validators":76,"./patch":62,"object-assign":23}],64:[function(require,module,exports){
...
},{"../validators":76,"object-assign":23}],65:[function(require,module,exports){
...
},{"make-error":21,"object-assign":23}],67:[function(require,module,exports){
...
},{"./errors":66,"./nodeMiddleware":65,"@sanity/observable/minimal":80,"get-it":4,"get-it/lib/middleware/jsonRequest":8,"get-it/lib/middleware/jsonResponse":9,"get-it/lib/middleware/observable":10,"get-it/lib/middleware/progress":12,"object-assign":23}],69:[function(require,module,exports){
...
},{"object-assign":23}],73:[function(require,module,exports){
...
},{"eventsource-polyfill/dist/eventsource":2}],78:[function(require,module,exports){
...
},{"../operators/filter":81,"../operators/map":82,"../operators/reduce":83,"object-assign":23,"rxjs/internal/Observable":27}],80:[function(require,module,exports){
module.exports=require("./lib/SanityObservableMinimal");
},{"./lib/SanityObservableMinimal":79}],81:[function(require,module,exports){
exports.filter=require("rxjs/internal/operators/filter").filter;
},{"rxjs/internal/operators/filter":34}],82:[function(require,module,exports){
exports.map=require("rxjs/internal/operators/map").map;

},{"rxjs/internal/operators/map":35}],83:[function(require,module,exports){
exports.reduce=require("rxjs/internal/operators/reduce").reduce;
},{"rxjs/internal/operators/reduce":36}]},{},[71])(71)
});
