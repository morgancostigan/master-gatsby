...
const toppingsWithCounts=countPizzasForTopping(pizzas.nodes);// console.log({toppingsWithCounts});
//5. Link it
...
// set state
setHotSlices(res.data.StoreSettings.hotSlices);setSlicemasters(res.data.StoreSettings.slicemaster);}).catch(err=>{// console.log('Oh Zang!');
// console.log(err);
...
function addToOrder(orderedPizza){// console.log({ orderedPizza })
// console.log('previous order total', order);
setOrder([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(order),[orderedPizza]));};// console.log('order', order);
//3. make a remove function
function removeFromOrder(index){setOrder([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(order.slice(0,index)),Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(order.slice(index+1))));};async function submitOrder(e){e.preventDefault();// console.log({e});
setLoading(true);setError(null);setMessage(null);//gather data to be sent
const body={order:Object(_attachNamesAndPrices__WEBPACK_IMPORTED_MODULE_3__["default"])(order,pizzas),total:Object(_calculateOrderTotal__WEBPACK_IMPORTED_MODULE_4__["default"])(order,pizzas),name:values.name,email:values.email,dreadPirateJimmy:values.dreadPirateJimmy};// console.log({body});
